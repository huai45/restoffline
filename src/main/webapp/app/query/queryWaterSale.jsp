...
$(document).ready(function(){
     ...
     $("#waterquerypage").addClass("left_menu_sel");
	...
	$("#queryBtn").click(function(){
        ...
        document.location.href="/transPage?page=/query/queryWaterSale&start_date="+start_date+"&end_date="+end_date;
	});
...
<div id="center" data-options="region:'center',border:false,style:{borderWidth:0}" style="padding:0px;background:#FFF;">
    <div id="startpage" style="height:50px;width:95%;padding-left:0px;line-height:50px;border-bottom:solid 0px #CCCCCC;font-size:20px;">
        <div id="" style="height:50px;width:100%;line-height:50px;border-bottom:solid 1px #CCCCCC;font-size:20px;">
	        ...
	        <div style="display:none;float:left;height:50px;line-height:50px;margin-left:15px;margin-right:5px;">
	               每日统计
	        </div>
        </div>
    </div>
    ...
    <div id="center">
	    ...
	    <div style="margin-left:10px;margin-top:20px;margin-bottom:0px;font-size:22px;"><%= "酒水销售明细" %>
        ...
        <div class="audit_list" style="width:930px;">
            <div class="order_head" style="">
	            <div style="float:left;padding-top:1px;width:100px;text-align:center;" >
	                &nbsp;菜号
	            </div>
	            <div style="width:80px;" ></div>
	            <div style="width:250px;" >名称</div>
	            <div style="width:150px;" >单价(元)</div>
	            <div style="width:100px;" >发生数量</div>
	            <div style="width:100px;" >出库数量</div>
	            <div style="width:100px;" >退菜数量</div>
	            <div style="width:100px;" >赠送数量</div>
	        </div>
	        <div id="show_list">
            <% 
                for(int i=0;i<details.size();i++){
                   Map food = (Map)details.get(i);
            %>
            <div class="order_tr" id="<%= food.get("food_id") %>" >
                <div style="float:left;padding-top:1px;width:100px;text-align:center;" >
	                &nbsp;<%= food.get("food_id") %>
	            </div>
	            <div class="bluefont1 bluefont" style="width:250px;" ><%= food.get("food_name") %></div>
	            <div style="width:150px;" ><%= food.get("price")+" / "+food.get("unit") %></div>
	            <div style="width:100px;" ><%= food.get("count") %>&nbsp;</div>
	            <div style="width:100px;" ><%= food.get("out_count") %>&nbsp;</div>
	            <div style="width:100px;" ><%= food.get("back_count") %>&nbsp;</div>
	            <div style="width:100px;" ><%= food.get("free_count") %>&nbsp;</div>
	        </div>
	        <% } %>
