...
$(document).ready(function(){
     ...
     $("#queryStaffMoneyByDay").addClass("left_menu_sel");
	...
	$("#queryBtn").click(function(){
        ...
        document.location.href="/transPage?page=/query/queryStaffMoneyByDay&start_date="+start_date+"&end_date="+end_date+"&staff_name="+staff_name;
	});
    ...
    <div id="center">
        ...
        <div class="audit_list" style="width:930px;">
            ...
            <div class="order_tr" id="<%= staffData.get("oper_date") %>" >
	            ...
	            <div class="bluefont1 bluefont" style="width:200px;" ><%= staffData.get("oper_date") %></div>
	            <div style="width:10px;" ></div>
	            <div style="width:200px;" ><%= staffData.get("count") %></div>
	            <div style="width:300px;" ><%= staffData.get("real_count") %>&nbsp;</div>
	        </div>
	        <% } %>
