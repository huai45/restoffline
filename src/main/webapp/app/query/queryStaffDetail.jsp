...
List staffList = jdbcTemplate.queryForList(" select username user_id,username from td_android_user where 1 = 1 ",
    new Object[]{} );
...
$(document).ready(function(){
     ...
     $("#queryStaffDetail").addClass("left_menu_sel");
	...
	$("#queryBtn").click(function(){
	    ...
	    var staff_name = $("#staff_name").find("option:selected").text();
	    var start_date = $('#start_year').val()+"-"+$('#start_month').val()+"-"+$('#start_day').val();
	    var end_date = $('#end_year').val()+"-"+$('#end_month').val()+"-"+$('#end_day').val();
        document.location.href="/transPage?page=/query/queryStaffDetail&start_date="+start_date+"&end_date="+end_date+"&staff_id="+staff_id+"&staff_name="+staff_name;
	});
...
<div id="center" data-options="region:'center',border:false,style:{borderWidth:0}" style="padding:0px;background:#FFF;">
        ...
        <div id="" style="height:50px;width:100%;line-height:50px;border-bottom:solid 1px #CCCCCC;font-size:20px;">
	        ...
	        <div style="float:left;height:50px;line-height:30px;margin-right:15px;">
	            <select id="staff_name" style="float:left;margin-top:11px;border:solid 1px #CCCCCC;padding:0px;line-height:30px;width:100px; height:30px;font-size:18px; ">
					...
					%>
					<option value="<%= staff.get("USER_ID") %>"><%= staff.get("username") %></option>
					<% 
					}
					%>
				</select>
    ...
    <div id="center">
	    ...
	    <div style="margin-left:10px;margin-top:20px;margin-bottom:0px;font-size:22px;"><%= "员工("+staff_name+")个人销售查询" %>
