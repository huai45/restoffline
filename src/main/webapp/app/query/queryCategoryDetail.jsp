...
$(document).ready(function(){
     ...
     $("#categorydetailpage").addClass("left_menu_sel");
	...
	$("#queryBtn").click(function(){
		...
		form.attr("action","/file/exportCategorySaleDetailFile.html");
...
<div id="center" data-options="region:'center',border:false,style:{borderWidth:0}" style="padding:0px;background:#FFF;">
    ...
    <div id="center">
	    ...
	    <div style="margin-left:10px;margin-top:20px;margin-bottom:0px;font-size:22px;">档口销售明细数据
